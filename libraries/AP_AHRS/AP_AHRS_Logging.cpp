                                ...
                                const AC_PosControl &pos_control) const
{
    ...
    const struct log_Rate pkt_rate{
        ...
        roll            : degrees(get_gyro_latest().x),
        roll_out        : motors.get_roll()+motors.get_roll_ff()*0.0f,
        control_pitch   : degrees(rate_targets.y),
        pitch           : degrees(get_gyro_latest().y),
        pitch_out       : motors.get_pitch()+motors.get_pitch_ff()*0.0f,
        control_yaw     : degrees(rate_targets.z),
        yaw             : degrees(get_gyro_latest().z),
        yaw_out         : motors.get_yaw()+motors.get_yaw_ff()*0.0f,
