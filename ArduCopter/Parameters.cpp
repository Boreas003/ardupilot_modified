...
const AP_Param::Info Copter::var_info[] = {
    ...
    // @Values: 0:Stabilize,1:Acro,2:AltHold,3:Auto,4:Guided,5:Loiter,6:RTL,7:Circle,9:Land,11:Drift,13:Sport,14:Flip,15:AutoTune,16:PosHold,17:Brake,18:Throw,19:Avoid_ADSB,20:Guided_NoGPS,21:Smart_RTL,22:FlowHold,23:Follow,24:ZigZag,25:SystemID,26:Heli_Autorotate,27:Auto RTL,28:Turtle,29:Ground,30:Depthctrl,31:Test
    // @User: Standard
...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @RebootRequired: True
	// UUV specified
    AP_GROUPINFO("FRAME_CLASS", 18, ParametersG2, frame_class, DEFAULT_FRAME_CLASS),
...
void Copter::convert_pid_parameters(void)
{
    ...
    const AP_Param::ConversionInfo pid_conversion_info[] = {
		...
		{ Parameters::k_param_pid_dep_pitch, 0, AP_PARAM_FLOAT, "ATC_DEP_PIT_P" },
		{ Parameters::k_param_pid_dep_pitch, 1, AP_PARAM_FLOAT, "ATC_DEP_PIT_I" },
		{ Parameters::k_param_pid_dep_pitch, 2, AP_PARAM_FLOAT, "ATC_DEP_PIT_D" },
#if FRAME_CONFIG == HELI_FRAME
    ...
    const AP_Param::ConversionInfo imax_conversion_info[] = {
		...
		{ Parameters::k_param_pid_dep_pitch,   5, AP_PARAM_FLOAT, "ATC_DEP_PIT_IMAX" },
#if FRAME_CONFIG == HELI_FRAME
    ...
    const AP_Param::ConversionInfo angle_and_filt_conversion_info[] = {
		...
		{ Parameters::k_param_pid_dep_pitch, 6, AP_PARAM_FLOAT, "ATC_DEP_PIT_FILT" },
